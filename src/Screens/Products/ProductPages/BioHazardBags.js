  ...
  const data = [
    {
      ...
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.PRICE,
    },
    {
      key: translations.PRODUCT_DETAILS.COMMON.MOQ,
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.MOQ,
    },
    {
      key: translations.PRODUCT_DETAILS.COMMON.BUSINESS_TYPE,
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.BUSINESS_TYPE,
    },
    {
      key: translations.PRODUCT_DETAILS.COMMON.SIZE,
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.SIZE,
    },
    {
      key: translations.PRODUCT_DETAILS.COMMON.MATERIAL,
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.MATERIAL,
    },
    {
      key: translations.PRODUCT_DETAILS.COMMON.APPLICATION,
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.APPLICATION,
    },
    {
      key: translations.PRODUCT_DETAILS.COMMON.COUNTRY_OF_ORIGIN,
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.COUNTRY_OF_ORIGIN,
    },
    {
      key: translations.PRODUCT_DETAILS.COMMON.PLASTIC_TYPE,
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.PLASTIC_TYPE,
    },
    {
      key: translations.PRODUCT_DETAILS.COMMON.CUSTOM_ORDER,
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.CUSTOM_ORDER,
    },
    {
      key: translations.PRODUCT_DETAILS.COMMON.COLOR,
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.COLOR,
    },
    {
      key: translations.PRODUCT_DETAILS.COMMON.BRAND_NAME,
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.BRAND_NAME,
    },
    {
      key: translations.PRODUCT_DETAILS.COMMON.FEATURE,
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.FEATURE,
    },
    {
      key: translations.PRODUCT_DETAILS.COMMON.PRODUCT_CODE,
      value: translations.PRODUCT_DETAILS.BIO_HAZARD_BAGS.PRODUCT_CODE,
    },
  ];
